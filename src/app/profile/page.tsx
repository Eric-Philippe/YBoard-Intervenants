...
export default function ProfilePage() {
  ...
  const updateProfileMutation = api.users.updateProfile.useMutation({
    ...
    onError: (error) => {
      ...
      setLoading(false);
      notifications.show({ title: "Erreur", message: `Erreur lors de la mise à jour : ${error.message}`, color: "red" });
    },
  });
          ...
          <div className="glass-card">
            <div className="px-4 py-5 sm:p-6">
              <div className="mb-4 flex items-center justify-between">
                ...
                {!editMode && (
                  <button onClick={handleEditProfile} className="btn-secondary" disabled={loading}>
                    <IconPencil size={16} />
                    Modifier
                  </button>
                )}
          ...
          <div className="glass-card">
            <div className="px-4 py-5 sm:p-6">
              <div className="mb-4 flex items-center justify-between">
                ...
                {!changePasswordMode && (
                  <button onClick={handleChangePassword} className="btn-secondary" disabled={loading}>
                    <IconLock size={16} />

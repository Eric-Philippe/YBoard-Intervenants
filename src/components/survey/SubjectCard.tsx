  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-start">
        ...
        <div className="flex flex-row gap-2 sm:w-28 sm:flex-col sm:items-stretch">
          {[
            ...
            <button
              ...
              className={`rounded-lg border px-3 py-2 text-center text-sm font-semibold transition-all duration-150 ${
                response === opt.value
                  ? opt.activeClass

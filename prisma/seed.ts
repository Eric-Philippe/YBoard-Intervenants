...
const categorySeedData: CategoryData[] = [
  {
    slug: "bachelor-1", label: "Bachelor 1",
    level: "bachelor", year: 1, sortOrder: 1,
    title: "Bachelor 1 - Première année",
    introduction: "Bienvenue dans le questionnaire pour les interventions en Bachelor 1. Cette promotion est composée d'étudiants débutant leur parcours en informatique. Les modules couvrent les fondamentaux du développement web, de l'algorithmie, des réseaux et de la programmation.",
    subjects: [
      { title: "HTML/CSS", volumeHoraire: 8, periode: "Octobre", avecMentor: true, contenu: `• Comprendre l'usage professionnel du HTML/CSS : standards web (W3C), bonnes pratiques, accessibilité (WCAG)
...
• Réaliser votre premier site vitrine`, sortOrder: 1 },
      { title: "JavaScript & DOM", volumeHoraire: 16, periode: "Janvier / février", avecMentor: true, contenu: `• Maîtriser la syntaxe JavaScript : variables, fonctions, boucles, conditions, types
...
• Créer une application interactive complexe s'exécutant entièrement dans le navigateur`, sortOrder: 2 },
      { title: "Développement Web & Consommation d'API", volumeHoraire: 12, periode: "Novembre / décembre", avecMentor: true, contenu: `• Consommer une API REST externe en Go avec gestion appropriée des erreurs HTTP (404, 500, timeout)
...
• Utiliser les templates Go pour générer des pages HTML dynamiques à partir de données`, sortOrder: 3 },
      { title: "Algorithmie", volumeHoraire: 16, periode: "Novembre", avecMentor: true, contenu: `• Analyser la complexité algorithmique d'une solution en utilisant la notation Big-O
...
• Documenter son approche algorithmique et expliquer ses choix d'implémentation`, sortOrder: 4 },
      { title: "Application CLI & Parsing en Go", volumeHoraire: 12, periode: "Octobre", avecMentor: true, contenu: `• Concevoir l'architecture d'une application CLI en Go avec séparation des responsabilités (main, utilitaires)
...
• Documenter son projet avec un README complet (description, installation, utilisation)`, sortOrder: 5 },
      { title: "Virtualisation & Administration Poste Client", volumeHoraire: 20, periode: "Janvier", avecMentor: false, contenu: `• Comprendre les principes de la virtualisation : différencier les types d'hyperviseurs (type 1 / type 2), savoir lequel choisir selon le contexte
...
• Appliquer les bonnes pratiques de sécurité du poste client Windows (Windows Update, BitLocker, Windows Defender)`, sortOrder: 6 },
      { title: "Fonctionnement des réseaux", volumeHoraire: 40, periode: "Décembre", avecMentor: false, contenu: `• Expliquer les modèles OSI et TCP/IP et le rôle de chaque couche dans la transmission des données
...
• Comparer les technologies réseau filaires et sans fil : avantages, inconvénients, cas d'usage`, sortOrder: 7 },
      { title: "Linux Fondamentaux", volumeHoraire: 40, periode: "Mars", avecMentor: false, contenu: `• Maîtriser les commandes essentielles de navigation, manipulation de fichiers, recherche et gestion des processus en ligne de commande
...
• Configurer des services serveur de base : serveur web, partage de fichiers, réseau`, sortOrder: 8 },
      { title: "POO & Python", volumeHoraire: 36, periode: "Mars", avecMentor: false, contenu: `• Comprendre et appliquer les 4 piliers de la POO : encapsulation, héritage, polymorphisme, abstraction
...
• Appliquer la POO dans un projet concret en Python avec des classes modulaires et réutilisables`, sortOrder: 9 },
      { title: "Outils IA", volumeHoraire: 12, periode: "Novembre", avecMentor: false, contenu: `• Expliquer le fonctionnement d'un Large Language Model et identifier ses limites (hallucinations, biais)
...
• Argumenter sur les enjeux éthiques et de propriété intellectuelle liés à l'utilisation de l'IA`, sortOrder: 10 },
      { title: "Langage Compilé vs Interprété", volumeHoraire: 20, periode: "Juin", avecMentor: false, contenu: `• Distinguer les deux modèles d'exécution :compilation et interprétation, en comprenant le cycle de vie complet du code source dans chaque cas, de Go à Python
...
• Choisir un langage de manière argumentée selon le contexte projet : performance, rapidité de développement, portabilité, environnement d'exécution et écosystème`, sortOrder: 11 },
    ],
  },
  {
    slug: "bachelor-2-informatique", label: "Bachelor 2 - Informatique",
    level: "bachelor", year: 2, specialization: "informatique", sortOrder: 2,
    title: "Bachelor 2 - Spécialisation Informatique",
    introduction: "Cette promotion approfondit le développement web, les bases de données, la cybersécurité et le DevOps. Les étudiants ont déjà des bases en algorithmique et développement web.",
    subjects: [
      { title: "React.js & TypeScript", volumeHoraire: 16, periode: "Septembre à novembre", avecMentor: true, contenu: `• Typer du code JavaScript avec TypeScript (types primitifs, interfaces, génériques, union types)
...
• Créer des hooks personnalisés pour réutiliser la logique métier`, sortOrder: 1 },
      { title: "Python Backend & FastAPI", volumeHoraire: 20, periode: "Septembre à novembre", avecMentor: true, contenu: `• Révision rapide de la POO Python : classes, héritage, polymorphisme appliqués au backend
...
• Débugger efficacement du code Python backend (breakpoints, logging)`, sortOrder: 2 },
      { title: "Travail collaboratif & documentation technique", volumeHoraire: 12, periode: "Octobre", avecMentor: false, contenu: `• Pratiquer la code review structurée : commentaires constructifs sur les PR (lisibilité, performance, sécurité)
...
• Communiquer un blocage technique de manière concise et actionnable`, sortOrder: 3 },
      { title: "SQL avancé", volumeHoraire: 12, periode: "Octobre", avecMentor: true, contenu: `• Comprendre le rôle du DCL et la notion de privilèges dans une base de données
...
• Identifier dans un projet réel quand utiliser ces outils plutôt que de gérer la logique côté applicatif`, sortOrder: 4 },
      { title: "Réseaux", volumeHoraire: 36, periode: "Novembre", avecMentor: false, contenu: `• Installer et configurer un serveur DHCP sous Linux pour l'attribution automatique d'adresses IP
...
• Sécuriser les services réseaux selon les bonnes pratiques (principe du moindre privilège, logs)`, sortOrder: 5 },
      { title: "Windows Server", volumeHoraire: 28, periode: "Novembre", avecMentor: false, contenu: `• Installer et configurer Windows Server 2022 (rôles, fonctionnalités, paramètres réseau)
...
• Joindre des postes clients au domaine Active Directory et vérifier l'application des GPO`, sortOrder: 6 },
      { title: "Accessibilité Web & SEO", volumeHoraire: 16, periode: "Décembre", avecMentor: false, contenu: `Accessibilité
...
• Appréhender les bases du SEA et sa complémentarité avec le SEO`, sortOrder: 7 },
      { title: "Data Engineering Python", volumeHoraire: 12, periode: "Janvier", avecMentor: true, contenu: `• Manipuler des données avec Pandas (DataFrames, Series, indexing)
...
• Automatiser un pipeline ETL complet (extraction, transformation, chargement)`, sortOrder: 8 },
      { title: "Sensibilisation à la cybersécurité", volumeHoraire: 16, periode: "Janvier", avecMentor: false, contenu: `• Identifier les menaces courantes (phishing, ransomware, malware, DDoS) et leurs vecteurs d'attaque
...
• Sensibiliser ses pairs aux bonnes pratiques de sécurité`, sortOrder: 9 },
      { title: "Conception POO & Design Patterns", volumeHoraire: 28, periode: "Février", avecMentor: false, contenu: `• Appliquer les 5 principes SOLID dans la conception de classes et justifier chaque principe sur un exemple concret
...
• Implémenter un mini-projet architecturé combinant au moins 3 design patterns"`, sortOrder: 10 },
      { title: "Tests automatisés", volumeHoraire: 16, periode: "Mars", avecMentor: false, contenu: `• Comprendre pourquoi les tests sont indispensables dans un projet professionnel
...
• Lancer une suite de tests simple et lire son résultat`, sortOrder: 11 },
      { title: "Introduction aux bases du Cloud", volumeHoraire: 16, periode: "Mars", avecMentor: false, contenu: `• Expliquer les modèles de service Cloud (IaaS, PaaS, SaaS) et identifier le modèle adapté à un besoin
...
• Estimer le coût d'une infrastructure Cloud simple (calculateur de prix)`, sortOrder: 12 },
      { title: "SPE INFO Introduction DevOps & Culture CI/CD", volumeHoraire: 32, periode: "Avril", avecMentor: false, contenu: `• Expliquer les principes DevOps (culture, automatisation, mesure, partage) et leur valeur en entreprise
...
• Mettre en place un environnement de staging distinct de la production`, sortOrder: 13 },
      { title: "Conteneurisation", volumeHoraire: 12, periode: "Avril", avecMentor: true, contenu: `• Écrire des Dockerfiles optimisés avec multi-stage builds (réduire une image de 1Go à <200Mo)
...
• Déployer une stack complète avec docker-compose up en un seul commande`, sortOrder: 14 },
      { title: "SPE INFO Introduction IoT & Automation", volumeHoraire: 32, periode: "Mai", avecMentor: false, contenu: `• Programmer un ESP32 en MicroPython pour interagir avec le monde physique
...
• Débugger un système embarqué (serial monitor, logs, multimètre)`, sortOrder: 15 },
      { title: "SPE INFO Scripting & Automatisation Système", volumeHoraire: 28, periode: "Juin", avecMentor: false, contenu: `• Écrire des scripts Bash robustes avec gestion d'erreurs (set -euo pipefail), logging, et paramétrage
...
• Versionner ses scripts dans Git et les maintenir comme du code de production`, sortOrder: 16 },
      { title: "Mise en Production & Hébergement", volumeHoraire: 8, periode: "Février", avecMentor: true, contenu: `• Distinguer les environnements de développement, staging et production et comprendre leur rôle
...
• Comprendre ce que sont la CI/CD, le monitoring et le logging et à quoi ils servent`, sortOrder: 17 },
    ],
  },
  {
    slug: "bachelor-2-ia-data", label: "Bachelor 2 - IA & Data",
    level: "bachelor", year: 2, specialization: "ia_data", sortOrder: 3,
    title: "Bachelor 2 - Spécialisation IA & Data",
    introduction: "Cette promo aborde la data engineering, la business intelligence et l'analyse de données. Les étudiants maîtrisent Python et souhaitent se spécialiser dans la data science.",
    subjects: [
      { title: "React.js & TypeScript", volumeHoraire: 16, periode: "Septembre à novembre", avecMentor: true, contenu: `• Typer du code JavaScript avec TypeScript (types primitifs, interfaces, génériques, union types)
• Configurer un projet TypeScript avec tsconfig.json et comprendre les options de compilation
• Créer des composants React fonctionnels avec JSX et les typer avec TypeScript
...
• Pusher et puller des images sur DockerHub (registry publique/privée)
• Containeriser une application fullstack complète (React + FastAPI + PostgreSQL)
• Déployer une stack complète avec docker-compose up en un seul commande`, sortOrder: 13 },
      { title: "Mise en Production & Hébergement", volumeHoraire: 8, periode: "Février", avecMentor: true, contenu: `• Distinguer les environnements de développement, staging et production et comprendre leur rôle
• Gérer les variables d'environnement et protéger les secrets d'une application
• Comprendre le fonctionnement des noms de domaine et des DNS (A record, CNAME)
• Comprendre ce qu'est le HTTPS et pourquoi un certificat SSL est obligatoire en production
...
• Mettre en place un déploiement continu depuis GitHub
• Savoir lire les logs d'une application pour diagnostiquer un problème basique
• Comprendre ce que sont la CI/CD, le monitoring et le logging et à quoi ils servent`, sortOrder: 14 },
      { title: "SPE DATA Business Intelligence", volumeHoraire: 24, periode: "Mai", avecMentor: false, contenu: `• Comprendre les principes de la Business Intelligence et son rôle dans le cycle de vie des données d'entreprise.
...
• Respecter les bonnes pratiques et les cadres réglementaires tels que le RGPD dans la manipulation des données analytiques.`, sortOrder: 15 },
      { title: "SPE DATA Analyses et calcul numérique", volumeHoraire: 16, periode: "AVRIL", avecMentor: false, contenu: `• Maîtriser les calculs matriciels et la manipulation des vecteurs.
...
• Intégrer des calculs numériques dans des processus d’analyse de données.`, sortOrder: 16 },
      { title: "SPE DATA Extraction et transformation des flux de données", volumeHoraire: 16, periode: "Avril", avecMentor: false, contenu: `• Découvrir et utiliser un ETL open-source pour extraire, transformer et charger des données.
...
• Documenter les processus ETL pour garantir leur maintenabilité et leur conformité`, sortOrder: 17 },
      { title: "SPE DATA Manipulation massive de données", volumeHoraire: 16, periode: "Juin", avecMentor: false, contenu: `• Apprendre à manipuler des données volumineuses à l’aide de bibliothèques Python comme Pandas, Dask ou PySpark.
...
• Mettre en œuvre des workflows pratiques pour intégrer et traiter des données issues de multiples sources.`, sortOrder: 18 },
    ],
  },
  {
    slug: "bachelor-3-developpement", label: "Bachelor 3 - Développement",
    level: "bachelor", year: 3, specialization: "developpement", sortOrder: 4,
    title: "Bachelor 3 - Spécialisation Développement",
    introduction: "En troisième année, les étudiants approfondissent l'architecture logicielle, le développement fullstack moderne et les pratiques DevOps avancées.",
    subjects: [
      { title: "Bases de Données Non Relationnelles", volumeHoraire: 14, periode: "Décembre", avecMentor: false, contenu: `• Identifier les 4 grands paradigmes NoSQL (document, clé-valeur, colonne, graphe) et leurs cas d'usage respectifs
...
• Choisir et justifier le bon type de base de données selon les contraintes d'un projet réel`, sortOrder: 1 },
      { title: "Bases de Données Relationnelles Avancées", volumeHoraire: 7, periode: "Novembre / décembre", avecMentor: false, contenu: `• Optimiser les performances d'une requête lente en lisant et interprétant un plan d'exécution avec EXPLAIN ANALYZE
...
• Dénormaliser stratégiquement un schéma pour répondre à des contraintes de performance ou de reporting, en sachant mesurer le gain réel avec EXPLAIN ANALYZE`, sortOrder: 2 },
      { title: "Conception et architecture des données", volumeHoraire: 14, periode: "Novembre", avecMentor: false, contenu: `• Concevoir un MCD à partir d'un cahier des charges métier et le traduire en schéma physique (MLD, MPD)
...
• Concevoir une architecture de données polyglotte combinant SQL et NoSQL dans une même application`, sortOrder: 3 },
      { title: "Sécurité Applicative & RGPD", volumeHoraire: 14, periode: "Janvier", avecMentor: false, contenu: `• Repérer et corriger les 5 vulnérabilités OWASP les plus courantes sur une application réelle (injection SQL, XSS, CSRF, IDOR, broken auth)
...
• Réaliser un audit de sécurité basique sur une application existante et rédiger un rapport de remédiation`, sortOrder: 4 },
      { title: "Conception d'Interfaces", volumeHoraire: 14, periode: "Novembre", avecMentor: false, contenu: `• Appliquer les grandes lois ergonomiques (Fitts, Hick, Miller, proximité Gestalt) à la conception concrète d'une interface
...
• Mener un test utilisateur et itérer sur le design à partir des retours collectés`, sortOrder: 5 },
      { title: "Architecture Hexagonale & DDD", volumeHoraire: 28, periode: "Octobre", avecMentor: false, contenu: `• Distinguer les responsabilités des couches présentation, métier et infrastructure dans une architecture en couches
...
• Rédiger un document d'architecture technique (diagrammes UML composants + séquence) pour un projet d'équipe`, sortOrder: 6 },
      { title: "Projet Fil Rouge Application Full-Stack", volumeHoraire: 35, periode: "Novembre / juin", avecMentor: false, contenu: `• Concevoir l'architecture complète d'une application avec diagrammes C4, choix technologiques argumentés et modèle de données
...
• Livrer en sprints agiles avec code reviews, tests automatisés (couverture >70%) et documentation technique complète`, sortOrder: 7 },
      { title: "Développement Backend & Microservices", volumeHoraire: 28, periode: "Février", avecMentor: false, contenu: `• Comprendre les différences fondamentales entre monolith modulaire et microservices : avantages, inconvénients, et critères de choix
...
• Appliquer les patterns de résilience fondamentaux : circuit breaker, retry avec backoff exponentiel et timeout`, sortOrder: 8 },
      { title: "Développement Frontend Avancé", volumeHoraire: 28, periode: "Mars", avecMentor: false, contenu: `• Développer une application Next.js complète en choisissant SSR (Server-Side Rendering) ou SSG (Static Site Generation) selon les besoins de chaque page
...
• Intégrer l'authentification (NextAuth.js), la gestion des rôles et la protection des routes côté client et côté serveur`, sortOrder: 9 },
      { title: "Clean Code & Refactoring", volumeHoraire: 14, periode: "Mars", avecMentor: false, contenu: `• Repérer et éliminer les code smells classiques (Long Method, God Class, Feature Envy, Shotgun Surgery) avec des refactorings ciblés
...
• Mesurer et réduire la dette technique avec de l'analyse statique (SonarQube) et des métriques de complexité cyclomatique`, sortOrder: 10 },
      { title: "Développement Mobile", volumeHoraire: 21, periode: "Avril", avecMentor: false, contenu: `• Comprendre les différences entre Expo et React Native CLI et mettre en place un projet React Native avec Expo
...
• Optimiser les performances de l'application : React.memo, FlatList virtualisée, lazy loading des images`, sortOrder: 11 },
      { title: "Qualité Logicielle & Testing Avancé", volumeHoraire: 14, periode: "Mai", avecMentor: false, contenu: `• Écrire des tests unitaires avec Jest sur des fonctions et composants isolés
...
• Intégrer Jest et Cypress dans un pipeline CI/CD basique et lire les rapports de résultats`, sortOrder: 12 },
      { title: "DevOps & Déploiement Continu", volumeHoraire: 28, periode: "Juin", avecMentor: false, contenu: `• Créer un pipeline CI/CD complet en 4 stages (build, test, security scan, deploy) avec GitHub Actions ou GitLab CI
...
• Configurer le monitoring applicatif avec Prometheus (métriques custom) et Grafana (dashboards d'alerte)`, sortOrder: 13 },
      { title: "Participation Projet & Agilité", volumeHoraire: 14, periode: "Octobre", avecMentor: false, contenu: `• Participer efficacement aux cérémonies Scrum : Daily, Sprint Planning, Review et Retrospective
...
• Conduire une rétrospective et formuler des actions d'amélioration concrètes et mesurables`, sortOrder: 14 },
      { title: "Communication Technique", volumeHoraire: 14, periode: "Février", avecMentor: false, contenu: `• Rédiger un ADR (Architecture Decision Record) pour justifier un choix technique de façon claire et structurée auprès de votre équipe
...
• Formaliser les spécifications fonctionnelles d'une feature à partir d'un besoin métier exprimé à l'oral`, sortOrder: 15 },
      { title: "Intégration API & Services Tiers", volumeHoraire: 21, periode: "Mai", avecMentor: false, contenu: `• Intégrer plusieurs services tiers dans une application (paiement, stockage, email) en gérant correctement les erreurs et les retry
...
• Écrire des tests d'intégration en mockant les services externes (VCR pattern, fixtures HTTP)`, sortOrder: 16 },
      { title: "Rétro-ingénierie & Audit de Code", volumeHoraire: 14, periode: "Avril", avecMentor: false, contenu: `• Analyser une base de données non documentée (50+ tables) et produire un MCD/MLD complet avec les relations identifiées
...
• Produire un rapport d'audit de code avec les points de dette technique, les vulnérabilités, les fragilités et des recommandations concrètes`, sortOrder: 17 },
      { title: "Échange de Données & Interopérabilité", volumeHoraire: 14, periode: "Janvier", avecMentor: false, contenu: `• Mettre en place des échanges de données avec différents formats de sérialisation (JSON, Protobuf, Avro) et comparer leurs performances selon les cas
...
• Versionner une API (URL versioning, header versioning) en gérant la rétrocompatibilité pour les clients existants`, sortOrder: 18 },
    ],
  },
  {
    slug: "bachelor-3-ia-data", label: "Bachelor 3 - IA & Data",
    level: "bachelor", year: 3, specialization: "ia_data", sortOrder: 5,
    title: "Bachelor 3 - Spécialisation IA & Data",
    introduction: "Cette promotion s'oriente vers le machine learning appliqué, les pipelines de données et la BI avancée. Les étudiants ont une bonne maîtrise de Python et du SQL.",
    subjects: [
      { title: "Conception et architecture des données", volumeHoraire: 14, periode: "Novembre", avecMentor: false, contenu: `• Concevoir un MCD à partir d'un cahier des charges métier et le traduire en schéma physique (MLD, MPD)
• Décider de normaliser ou dénormaliser un schéma selon les contraintes du projet (lecture intensive, reporting, fort trafic)
• Identifier les 4 paradigmes NoSQL (document, clé-valeur, colonne, graphe) et leurs cas d'usage respectifs
• Choisir et justifier le bon paradigme de base de données selon les contraintes d'un projet réel
• Concevoir une architecture de données polyglotte combinant SQL et NoSQL dans une même application`, sortOrder: 1 },
      { title: "Sécurité Applicative & RGPD", volumeHoraire: 14, periode: "Janvier", avecMentor: false, contenu: `• Repérer et corriger les 5 vulnérabilités OWASP les plus courantes sur une application réelle (injection SQL, XSS, CSRF, IDOR, broken auth)
• Mettre en place le chiffrement des données sensibles au repos et en transit (bcrypt, AES, TLS)
• Appliquer les exigences du RGPD dans le code : consentement, droit à l'oubli, minimisation des données, registre de traitement
• Réaliser un audit de sécurité basique sur une application existante et rédiger un rapport de remédiation`, sortOrder: 2 },
      { title: "Conception d'Interfaces", volumeHoraire: 14, periode: "Octobre", avecMentor: false, contenu: `• Appliquer les grandes lois ergonomiques (Fitts, Hick, Miller, proximité Gestalt) à la conception concrète d'une interface
• Réaliser un wireframe et un prototype interactif sur Figma en respectant les critères d'accessibilité (WCAG 2.1 AA)
• Construire un design system minimal avec composants réutilisables, tokens de couleur et de typographie, et une documentation utilisable
• Mener un test utilisateur et itérer sur le design à partir des retours collectés`, sortOrder: 3 },
      { title: "Architecture Hexagonale & DDD", volumeHoraire: 28, periode: "Octobre", avecMentor: false, contenu: `• Distinguer les responsabilités des couches présentation, métier et infrastructure dans une architecture en couches
• Appliquer les principes SOLID à l'échelle d'une architecture complète et pas uniquement à l'échelle d'une classe
• Implémenter l'architecture hexagonale : ports, adapters et injection de dépendances pour isoler la logique métier de l'infrastructure
• Concevoir une application selon l'approche DDD : bounded contexts, aggregates, entités, value objects et domain events
• Identifier quand appliquer le DDD et quand une architecture plus simple suffit
• Refactorer une application non structurée vers une architecture hexagonale
• Rédiger un document d'architecture technique (diagrammes UML composants + séquence) pour un projet d'équipe`, sortOrder: 4 },
      { title: "Modélisation Décisionnelle & Data Warehousing", volumeHoraire: 21, periode: "Mai", avecMentor: false, contenu: `• Concevoir un schéma en étoile et en flocon à partir d'un besoin métier : tables de faits, dimensions, métriques agrégées
...
• Comparer les approches Kimball (bottom-up) et Inmon (top-down) et justifier le choix selon le contexte du projet`, sortOrder: 5 },
      { title: "Qualité Logicielle & Testing Avancé", volumeHoraire: 14, periode: "Mai", avecMentor: false, contenu: `• Écrire des tests unitaires avec Jest sur des fonctions et composants isolés
• Utiliser les mocks et spies Jest pour isoler les dépendances (API calls, modules externes)
• Structurer une suite de tests lisible et maintenable (nommage, organisation par feature, pattern AAA)
• Écrire des tests E2E avec Cypress sur un parcours utilisateur complet (formulaire, navigation, assertions DOM)
• Distinguer ce qui relève du test unitaire, du test d'intégration et du test E2E et choisir le bon outil
• Identifier les zones critiques d'un projet et prioriser la couverture en conséquence
• Intégrer Jest et Cypress dans un pipeline CI/CD basique et lire les rapports de résultats`, sortOrder: 6 },
      { title: "Projet Fil Rouge Pipeline Data End-to-End", volumeHoraire: 28, periode: "Novembre / juin", avecMentor: false, contenu: `• Concevoir l'architecture data complète : diagramme de flux, choix technologiques justifiés et modèle dimensionnel en étoile adapté au cas métier
...
• Livrer un dashboard décisionnel connecté au warehouse, combinant KPIs analytiques et résultats du modèle, avec une documentation utilisateur claire`, sortOrder: 7 },
      { title: "Mathématiques pour la Data", volumeHoraire: 28, periode: "Février", avecMentor: false, contenu: `• Réaliser des tests d'hypothèse (H0/H1, p-value, intervalle de confiance à 95%) et interpréter les résultats pour orienter une décision
...
• Calculer et interpréter une matrice de corrélation, identifier les variables colinéaires et appliquer une réduction de dimension (PCA)`, sortOrder: 8 },
      { title: "Machine Learning Appliqué", volumeHoraire: 21, periode: "Mars", avecMentor: false, contenu: `• Construire des pipelines Scikit-learn complets avec Pipeline() et ColumnTransformer, du preprocessing jusqu'au modèle, en garantissant l'absence de data leakage
...
• Identifier et corriger les pièges classiques : data leakage, overfitting, underfitting, biais de dataset et mauvais choix de métriques`, sortOrder: 9 },
      { title: "Python Data Engineering & SQL Avancé", volumeHoraire: 28, periode: "Mars / avril", avecMentor: false, contenu: `• Maîtriser les window functions SQL (ROW_NUMBER, RANK, LAG, LEAD, NTILE, PERCENT_RANK) et les CTEs récursifs pour l'analyse avancée
...
• Concevoir un pipeline polyglotte intégrant PostgreSQL, MongoDB et Redis dans une même architecture de traitement`, sortOrder: 10 },
      { title: "BI & Visualisation Avancée", volumeHoraire: 14, periode: "Juin", avecMentor: false, contenu: `• Concevoir un tableau de bord décisionnel avec Metabase ou Apache Superset : KPIs, filtres dynamiques, connexion directe au data warehouse
...
• Structurer une présentation data-driven synthétique avec recommandations actionnables pour un public métier`, sortOrder: 11 },
      { title: "DevOps & Déploiement Continu", volumeHoraire: 28, periode: "Juin", avecMentor: false, contenu: `• Créer un pipeline CI/CD complet en 4 stages (build, test, security scan, deploy) avec GitHub Actions ou GitLab CI
• Orchestrer une application multi-services avec Docker Compose (app + BDD + cache + reverse proxy) et des réseaux Docker
• Déployer une application sur un cluster Kubernetes : Pods, Services, Deployments, ConfigMaps, Ingress
• Configurer le monitoring applicatif avec Prometheus (métriques custom) et Grafana (dashboards d'alerte)`, sortOrder: 12 },
      { title: "Participation Projet & Agilité", volumeHoraire: 14, periode: "Octobre", avecMentor: false, contenu: `• Participer efficacement aux cérémonies Scrum : Daily, Sprint Planning, Review et Retrospective
• Rédiger des user stories avec critères d'acceptance et estimer en planning poker Fibonacci
•  Mettre en place les différents artefacts Scrum : Product Backlog, Sprint backlog, story mapping
• Utiliser Jira ou Notion pour suivre l'avancement d'un projet et produire un burndown chart
• Pratiquer le Kanban avec WIP limits et comprendre la différence entre pull et push
• Identifier les acteurs d'un processus métier, cartographier les flux d'information et extraire les règles de gestion
• Conduire une rétrospective et formuler des actions d'amélioration concrètes et mesurables`, sortOrder: 13 },
      { title: "Communication Technique", volumeHoraire: 14, periode: "Février", avecMentor: false, contenu: `• Rédiger un ADR (Architecture Decision Record) pour justifier un choix technique de façon claire et structurée auprès de votre équipe
• Présenter une démo technique de 10 minutes à un public mixte (technique et non-technique) avec un fil conducteur cohérent
• Produire une documentation de projet complète : guide d'installation, API reference (Swagger/OpenAPI), guide de contribution
• Formaliser les spécifications fonctionnelles d'une feature à partir d'un besoin métier exprimé à l'oral`, sortOrder: 14 },
      { title: "Rétro-ingénierie & Audit de Code", volumeHoraire: 14, periode: "Avril", avecMentor: false, contenu: `• Analyser une base de données non documentée (50+ tables) et produire un MCD/MLD complet avec les relations identifiées
• Reverser une API existante à partir du code source : identifier les endpoints, les modèles de données et les flux d'authentification
• Générer une spécification OpenAPI à partir d'une API non documentée et la valider
• Produire un rapport d'audit de code avec les points de dette technique, les vulnérabilités, les fragilités et des recommandations concrètes`, sortOrder: 15 },
      { title: "Échange de Données & Interopérabilité", volumeHoraire: 14, periode: "Janvier", avecMentor: false, contenu: `• Mettre en place des échanges de données avec différents formats de sérialisation (JSON, Protobuf, Avro) et comparer leurs performances selon les cas
• Définir un contrat de données (JSON Schema / data contract) pour fiabiliser les échanges entre systèmes
• Implémenter un pattern d'intégration asynchrone avec un message broker (RabbitMQ ou Redis Pub/Sub)
• Versionner une API (URL versioning, header versioning) en gérant la rétrocompatibilité pour les clients existants`, sortOrder: 16 },
      { title: "ETL, Pipelines et Orchestration", volumeHoraire: 28, periode: "Décembre", avecMentor: false, contenu: `• Formaliser le preprocessing comme étape de pipeline : politique de nulls (seuil de drop vs imputation), encodage et mise à l'échelle appliqués comme règles documentées et reproductibles, validation de distribution et de variance nulle comme filtres de qualité
...
• Monitorer les pipelines avec des métriques de performance (latence, volume, fraîcheur), détecter le data drift par tests statistiques et configurer des alertes proactives avant impact aval`, sortOrder: 17 },
    ],
  },
  {
    slug: "mastere-1-dev-fullstack", label: "Mastère 1 - Développement Fullstack",
    level: "mastere", year: 1, specialization: "dev_fullstack", sortOrder: 6,
    title: "Mastère 1 - Expert Développement Logiciel Fullstack",
    introduction: "Ce programme forme des développeurs fullstack experts capables de concevoir, développer et déployer des applications web complexes en utilisant les derniers outils et méthodologies du secteur.",
    subjects: [
      { title: "Domain-Driven Design", volumeHoraire: 21, periode: "Septembre", avecMentor: false, contenu: `• Identifier les bounded contexts d'un projet
...
• Comprendre les bases DDD sans aller dans la complexité`, sortOrder: 1 },
      { title: "Veille Technologique & Sélection de Solutions", volumeHoraire: 14, periode: "Janvier / février", avecMentor: false, contenu: `• Mettre en place un système de veille technologique structuré et efficace
...
• Présenter des recommandations techniques argumentées devant décideurs`, sortOrder: 2 },
      { title: "Fil Rouge FullStack : Cadrage", volumeHoraire: 19, periode: "Novembre / Juin", avecMentor: false, contenu: `• Constituer l'équipe et définir les rôles
• Cadrer le périmètre fonctionnel et technique du projet
• Rédiger le brief et les spécifications initiales
• Démarrer le développement
• Planifier les jalons jusqu'à la soutenance`, sortOrder: 3 },
      { title: "Stratégie de Tests & TDD", volumeHoraire: 35, periode: "", avecMentor: false, contenu: `• Pratiquer TDD avec cycle Red-Green-Refactor systématique
...
• Pratiquer BDD avec Cucumber pour collaboration métier/tech`, sortOrder: 4 },
      { title: "Optimisation Bases de Données & NoSQL", volumeHoraire: 21, periode: "", avecMentor: false, contenu: `• Concevoir le schéma de base de données d'un projet
...
• Choisir entre SQL et NoSQL selon les besoins projet`, sortOrder: 5 },
      { title: "Clean Architecture & API REST en microservice", volumeHoraire: 28, periode: "", avecMentor: false, contenu: `• Développer des APIs REST avec Clean Architecture (Domain/Application/Infrastructure)
...
• Gérer les patterns asynchrones (async/await, promises, queues)`, sortOrder: 6 },
      { title: "Développement Frontend Moderne", volumeHoraire: 28, periode: "", avecMentor: false, contenu: `• Maîtriser React ou Vue ou Angular avec composants complexes et hooks avancés
...
• Structurer une application avec patterns avancés (HOC, render props, composition)`, sortOrder: 7 },
      { title: "Performance & Optimisation Applicative", volumeHoraire: 14, periode: "", avecMentor: false, contenu: `• Identifier les bottlenecks d'un projet développement
...
• Atteindre un temps de chargement < 3 secondes`, sortOrder: 8 },
      { title: "Sécurité Applicative - OWASP Top 10", volumeHoraire: 21, periode: "Mars / mai", avecMentor: false, contenu: `• Prévenir les vulnérabilités OWASP Top 10 (injection, XSS, CSRF, etc.)
...
• Modéliser les menaces avec STRIDE et créer des plans de mitigation`, sortOrder: 9 },
      { title: "Méthodologies Agile & Scrum", volumeHoraire: 21, periode: "Octobre", avecMentor: false, contenu: `• Animer des cérémonies Scrum (daily, planning, retro, review) de manière productive
...
• Mesurer et améliorer avec les métriques Agile (cycle time, lead time, throughput)`, sortOrder: 10 },
      { title: "Infrastructure as Code & Monitoring de Base", volumeHoraire: 14, periode: "Avril / mai", avecMentor: false, contenu: `• Écrire des configurations Terraform avec HCL pour provisionner l'infrastructure
...
• Instrumenter une application pour exposer des métriques custom`, sortOrder: 11 },
      { title: "Estimation & Chiffrage de Projets Complexes", volumeHoraire: 14, periode: "Mai", avecMentor: false, contenu: `• Appliquer les techniques d'estimation adaptées au contexte
...
• Présenter et défendre un chiffrage auprès de décideurs`, sortOrder: 12 },
      { title: "Docker & Kubernetes Fondamentaux", volumeHoraire: 21, periode: "Janvier / février", avecMentor: false, contenu: `• Créer des Dockerfiles multi-stage optimisés pour réduire la taille des images
...
• Implémenter health checks et HPA pour la résilience et scalabilité`, sortOrder: 13 },
      { title: "Communication Projet & Reporting", volumeHoraire: 14, periode: "Février / mars", avecMentor: false, contenu: `• Rédiger des comptes-rendus d'activités clairs et actionnables
...
• Présenter efficacement les réalisations en sprint review`, sortOrder: 14 },
      { title: "CI/CD - Intégration & Déploiement Continu", volumeHoraire: 35, periode: "Novembre / janvier", avecMentor: false, contenu: `• Créer des pipelines CI multi-stages avec build, test, lint, security
...
• Intégrer SAST/SCA et gérer les environnements dynamiques par branche`, sortOrder: 15 },
      { title: "Analyse des Besoins & Faisabilité Technique", volumeHoraire: 28, periode: "Octobre / novembre", avecMentor: false, contenu: `• Cartographier les acteurs projet et définir leurs rôles (RACI/RASCI)
...
• Rédiger un rapport de faisabilité avec recommandation Go/No-Go`, sortOrder: 16 },
    ],
  },
  {
    slug: "mastere-2-dev-fullstack", label: "Mastère 2 - Développement Fullstack",
    level: "mastere", year: 2, specialization: "dev_fullstack", sortOrder: 7,
    title: "Mastère 2 - Expert Développement Logiciel Fullstack",
    introduction: "La deuxième année du mastère approfondit les sujets avancés de web services, développement cloud, coordination frontend/backend et conteneurisation.",
    subjects: [
      { title: "Web services", volumeHoraire: 63, periode: "Semestre 1", avecMentor: false, contenu: `APIS REST :
...
> Apprécier les conditions de succès des projets SOA et les exigences sur leur input`, sortOrder: 1 },
      { title: "Développer pour le cloud", volumeHoraire: 63, periode: "Semestre 2", avecMentor: false, contenu: `- Comprendre les principes fondamentaux du cloud et des architectures cloud-native, et identifier les solutions adaptées à différents besoins de développement. (C1.2.2, C1.3.2)
...
Documenter les déploiements et les évolutions des applications pour assurer la traçabilité et faciliter la collaboration entre équipes. (C2.4.1, C4.3.2)`, sortOrder: 2 },
      { title: "Coordination Front&Back", volumeHoraire: 63, periode: "Semestre 1", avecMentor: false, contenu: `- Superviser la coordination entre les équipes front-end et back-end pour assurer une collaboration fluide.
...
- Documenter les processus techniques et garantir leur traçabilité pour toutes les parties prenantes.`, sortOrder: 3 },
      { title: "Dév avec Docker", volumeHoraire: 28, periode: "Semestre,1", avecMentor: false, contenu: `- Acquérir une compréhension solide de Docker, y compris son architecture, son fonctionnement et ses cas d'usage.
...
- Comprendre l'intégration de Docker dans les workflows de développement et de déploiement continu (CI/CD) et dans les écosystèmes de microservices.`, sortOrder: 4 },
    ],
  },
  {
    slug: "mastere-1-dev-mobile-iot", label: "Mastère 1 - Développement Mobile & IoT",
    level: "mastere", year: 1, specialization: "dev_mobile_iot", sortOrder: 8,
    title: "Mastère 1 - Expert Développement Logiciel Mobile et IoT",
    introduction: "Ce programme forme des experts en développement mobile (Android, Flutter, React Native) et en solutions IoT connectées. Les étudiants apprennent à concevoir des applications performantes et des architectures embarquées.",
    subjects: [
      { title: "Développement Android Natif - Kotlin & Jetpack Compose", volumeHoraire: 28, periode: "Mai / juin", avecMentor: false, contenu: `• Configurer Android Studio, les émulateurs Android et le signing des APK/AAB
...
• Tester et distribuer une application Android (JUnit, Espresso, Firebase Distribution)`, sortOrder: 1 },
      { title: "Flutter & Développement Multi-Plateforme", volumeHoraire: 28, periode: "Mars / avril", avecMentor: false, contenu: `• Maîtriser les fondamentaux de Dart : typage fort, null safety, async/await et isolates
...
• Déployer l'application sur Android (et iOS si accès disponible) via CI/CD`, sortOrder: 2 },
      { title: "Stratégie de Tests IoT", volumeHoraire: 14, periode: "Juin", avecMentor: false, contenu: `• Identifier les spécificités des tests IoT et adapter sa stratégie en conséquence
...
• Tester la résilience (coupures réseau, firmware défaillant, données corrompues)`, sortOrder: 3 },
      { title: "React Native Avancé & Architecture Mobile", volumeHoraire: 21, periode: "Octobre / novembre", avecMentor: false, contenu: `• Architecturer une application React Native avec Clean Architecture : séparation Domain, Data et Presentation
...
• Configurer et utiliser EAS Build pour les releases`, sortOrder: 4 },
      { title: "Domain-Driven Design", volumeHoraire: 21, periode: "Septembre", avecMentor: false, contenu: `• Identifier les bounded contexts d'un projet
• Définir l'ubiquitous language avec le métier
• Modéliser les entités et value objects principaux
• Pratiquer l'event storming pour comprendre le domaine
• Créer un modèle de domaine simple pour démarrer le projet
• Comprendre les bases DDD sans aller dans la complexité`, sortOrder: 5 },
      { title: "Fil Rouge Mobile/IoT : Cadrage", volumeHoraire: 19, periode: "Novembre / juin", avecMentor: false, contenu: `• Cadrer un projet mobile ou IoT de A à Z
• Constituer et organiser le travail en équipe projet
• Produire les livrables de cadrage (brief, architecture, backlog)
• Soutenir le projet devant un jury`, sortOrder: 6 },
      { title: "Fondamentaux IoT & Protocoles de Communication", volumeHoraire: 35, periode: "Novembre / décembre", avecMentor: false, contenu: `• Concevoir une architecture IoT adaptée à un contexte donné en tenant compte des contraintes d'énergie, de latence et de bande passante
...
• Réaliser un audit de sécurité IoT basique (OWASP IoT Top 10)`, sortOrder: 7 },
      { title: "Veille Technologique & Sélection de Solutions", volumeHoraire: 14, periode: "Janvier / février", avecMentor: false, contenu: `• Mettre en place un système de veille technologique structuré et efficace
• Analyser les tendances technologiques et évaluer leur maturité (Hype Cycle)
• Réaliser des études comparatives rigoureuses de solutions techniques
• Évaluer les solutions en termes de sécurité, performance, coût et viabilité
• Analyser l'impact des choix technologiques sur dette technique et écoconception
• Présenter des recommandations techniques argumentées devant décideurs`, sortOrder: 8 },
      { title: "Sécurité Applicative - OWASP Top 10", volumeHoraire: 21, periode: "Mars / avril", avecMentor: false, contenu: `• Prévenir les vulnérabilités OWASP Top 10 (injection, XSS, CSRF, etc.)
• Implémenter une authentification sécurisée avec hashing adaptatif (bcrypt, Argon2)
• Configurer les headers HTTP de sécurité (CSP, HSTS, CORS)
• Valider et sanitizer toutes les entrées utilisateur de manière robuste
• Pratiquer le pentesting avec OWASP ZAP
...
• Rédiger un rapport de faisabilité avec recommandation Go/No-Go`, sortOrder: 16 },
  ...
  {
    slug: "mastere-2-dev-mobile-iot", label: "Mastère 2 - Développement Mobile & IoT",
    level: "mastere", year: 2, specialization: "dev_mobile_iot", sortOrder: 9,
    title: "Mastère 2 - Expert Développement Logiciel Mobile et IoT",
    introduction: "La deuxième année approfondit le développement mobile natif, les web services et le développement cloud pour des applications embarquées de grande envergure.",
    subjects: [
      { title: "Développement mobile", volumeHoraire: 63, periode: "Semestre 1", avecMentor: false, contenu: `"Maîtriser les plateformes de développement mobile natives : Être capable de développer des applications pour Android avec Java/Kotlin et pour iOS avec Swift.
...
Appliquer les meilleures pratiques de sécurité dans le développement mobile."`, sortOrder: 1 },
      { title: "Web services", volumeHoraire: 63, periode: "Semestre 1", avecMentor: false, contenu: `APIS REST :
> Découvrir les bonnes pratiques d’architecture et de design d’APIs ReSTful.
> Découvrir les menaces auxquelles s’exposent vos API.
> Découvrir les vulnérabilités les plus fréquentes.
...
> Être capable de trouver les "bons" services et de les documenter rigoureusement
> Appréhender la portée "système" et la nécessité de l'architecture logique
> Apprécier les conditions de succès des projets SOA et les exigences sur leur input`, sortOrder: 2 },
      { title: "Développer pour le cloud", volumeHoraire: 63, periode: "Semestre 2", avecMentor: false, contenu: `- Comprendre les principes fondamentaux du cloud et des architectures cloud-native, et identifier les solutions adaptées à différents besoins de développement. (C1.2.2, C1.3.2)
Concevoir des applications cloud en tirant parti des services comme la conteneurisation et les architectures serverless, tout en répondant aux exigences de scalabilité et de performance. (C1.5, C2.2.3)
Déployer et superviser des applications cloud sur des plateformes telles qu’AWS, GCP et Azure, en configurant les environnements et les outils nécessaires. (C2.1.1, C2.2.4)
Automatiser le déploiement des applications cloud à l’aide de pipelines d’intégration et de déploiement continu (CI/CD) pour garantir des mises à jour fluides et sans régression. (C2.1.2, C4.2.2)
Intégrer des outils de gestion de données cloud et de monitoring pour suivre la performance des applications et identifier les axes d’optimisation. (C4.1.2, C4.3.1)
Documenter les déploiements et les évolutions des applications pour assurer la traçabilité et faciliter la collaboration entre équipes. (C2.4.1, C4.3.2)`, sortOrder: 3 },
      { title: "Prog. cross-plateform (C)", volumeHoraire: 28, periode: "Semestre 1", avecMentor: false, contenu: `- Développer une maîtrise pratique de Flutter et React Native pour la création d'applications mobiles à la fois performantes et esthétiquement agréables, fonctionnant sur iOS et Android.
...
- Se familiariser avec les principes de conception UI/UX pour créer des interfaces utilisateur réactives et adaptatives qui offrent une expérience utilisateur cohérente sur divers appareils et tailles d'écran.`, sortOrder: 4 },
    ],
  },
  {
    slug: "mastere-1-integration-ia-dev", label: "Mastère 1 - Intégration IA & Développement",
    level: "mastere", year: 1, specialization: "integration_ia_dev", sortOrder: 10,
    title: "Mastère 1 - Expert en Intégration d'IA et Développement Logiciel",
    introduction: "Ce programme unique forme des développeurs capables d'intégrer les technologies d'intelligence artificielle (LLMs, deep learning) dans des applications logicielles robustes et scalables.",
    subjects: [
      { title: "Domain-Driven Design", volumeHoraire: 21, periode: "Septembre", avecMentor: false, contenu: `• Identifier les bounded contexts d'un projet
• Définir l'ubiquitous language avec le métier
• Modéliser les entités et value objects principaux
...
• Analyser l'impact des choix technologiques sur dette technique et écoconception
• Présenter des recommandations techniques argumentées devant décideurs`, sortOrder: 2 },
      { title: "Transformers & LLM", volumeHoraire: 19, periode: "Mars / mai", avecMentor: false, contenu: `•  Comprendre l'architecture transformer : encoder, decoder, self-attention, multi-head attention
...
•  Identifier les comportements émergents des LLMs et leurs implications pour le développement`, sortOrder: 3 },
      { title: "IA Multimodale : Vision, Audio & Génération", volumeHoraire: 21, periode: "Mai / juillet", avecMentor: false, contenu: `• Extraire structurellement les données d'un lot de factures scannées avec GPT-4o Vision avec > 95 % de précision
...
• Évaluer la qualité des sorties multimodales et gérer les cas limites (images floues, audio bruité)`, sortOrder: 4 },
      { title: "Fondamentaux du machine learning", volumeHoraire: 28, periode: "Novembre / décembre", avecMentor: false, contenu: `•  Identifier et traiter les problèmes courants d'un dataset : valeurs manquantes, types de variables…
...
•  Traduire des résultats en recommandation`, sortOrder: 5 },
      { title: "Développement Assisté par IA", volumeHoraire: 21, periode: "Mai / juin", avecMentor: false, contenu: `• Configurer des règles de projet (.cursorrules) pour guider Cursor IDE sur un projet Python/FastAPI en contexte d'équipe
...
• Définir les règles d'utilisation de l'IA pour une équipe (ce qui est autorisé, ce qui ne l'est pas)`, sortOrder: 6 },
      { title: "Deep Learning Fondamental", volumeHoraire: 14, periode: "Janvier / mars", avecMentor: false, contenu: `•  Comprendre le fonctionnement d'un réseau de neurones
...
•  Comprendre le rôle du transfer learning comme fondation de tout le DL moderne`, sortOrder: 7 },
      { title: "Consommation d'API IA & Prompt avancé", volumeHoraire: 21, periode: "Janvier", avecMentor: false, contenu: `• Implémenter le function calling / tool use pour connecter un LLM à une base de données réelle en production
...
• Construire un prompt engineering framework réutilisable pour votre équipe`, sortOrder: 8 },
      { title: "Bases de Données Vectorielles & Embeddings", volumeHoraire: 21, periode: "Mars / avril", avecMentor: false, contenu: `• Générer, stocker et requêter 10 000 embeddings dans Pinecone ou Qdrant en moins de 5 minutes de setup
...
• Mesurer la qualité du retrieval (recall@k, MRR) et identifier les faiblesses`, sortOrder: 9 },
      { title: "Sécurité Applicative - OWASP Top 10", volumeHoraire: 21, periode: "Mars / mai", avecMentor: false, contenu: `• Prévenir les vulnérabilités OWASP Top 10 (injection, XSS, CSRF, etc.)
• Implémenter une authentification sécurisée avec hashing adaptatif (bcrypt, Argon2)
• Configurer les headers HTTP de sécurité (CSP, HSTS, CORS)
• Valider et sanitizer toutes les entrées utilisateur de manière robuste
• Pratiquer le pentesting avec OWASP ZAP
• Modéliser les menaces avec STRIDE et créer des plans de mitigation`, sortOrder: 10 },
      { title: "Méthodologies Agile & Scrum", volumeHoraire: 21, periode: "Octobre", avecMentor: false, contenu: `• Animer des cérémonies Scrum (daily, planning, retro, review) de manière productive
• Estimer avec la méthode du poker planning et gérer la vélocité d'équipe
• Pratiquer Kanban avec des WIP limits et un flow management
• Conduire des retrospectives structurées avec des actions concrètes
• Collaborer efficacement avec le Product Owner sur la priorisation
• Mesurer et améliorer avec les métriques Agile (cycle time, lead time, throughput)`, sortOrder: 11 },
      { title: "Infrastructure as Code & Monitoring de Base", volumeHoraire: 14, periode: "Avril / mai", avecMentor: false, contenu: `• Écrire des configurations Terraform avec HCL pour provisionner l'infrastructure
• Créer des modules Terraform réutilisables et gérer le state avec remote backend
• Installer et configurer Prometheus pour collecter des métriques
• Créer des dashboards Grafana et configurer des alertes pertinentes
• Mettre en place des logs structurés pour faciliter le debug
• Instrumenter une application pour exposer des métriques custom`, sortOrder: 12 },
      { title: "Estimation & Chiffrage de Projets Complexes", volumeHoraire: 14, periode: "Mai", avecMentor: false, contenu: `• Appliquer les techniques d'estimation adaptées au contexte
• Décomposer un projet en unités estimables (WBS, user stories)
• Identifier et intégrer les charges indirectes et coûts cachés
• Construire un budget projet détaillé incluant tous les postes
• Calculer le TCO (Total Cost of Ownership) sur 3-5 ans
• Présenter et défendre un chiffrage auprès de décideurs`, sortOrder: 13 },
      { title: "Docker & Kubernetes Fondamentaux", volumeHoraire: 21, periode: "Janvier / février", avecMentor: false, contenu: `• Créer des Dockerfiles multi-stage optimisés pour réduire la taille des images
• Gérer volumes et réseaux Docker pour des applications complexes
• Sécuriser les conteneurs (scanning, non-root users, secrets management)
• Déployer des applications sur Kubernetes avec Deployments et Services
• Configurer Ingress pour exposer les services via HTTPS
• Implémenter health checks et HPA pour la résilience et scalabilité`, sortOrder: 14 },
      { title: "Communication Projet & Reporting", volumeHoraire: 14, periode: "Février / mars", avecMentor: false, contenu: `• Rédiger des comptes-rendus d'activités clairs et actionnables
• Préparer des présentations adaptées à différentes audiences
• Créer des dashboards de suivi projet visuels et pertinents
• Gérer la documentation projet et la traçabilité des décisions
• Adapter son discours technique selon l'audience
• Présenter efficacement les réalisations en sprint review`, sortOrder: 15 },
      { title: "CI/CD - Intégration & Déploiement Continu", volumeHoraire: 35, periode: "Novembre / janvier", avecMentor: false, contenu: `• Créer des pipelines CI multi-stages avec build, test, lint, security
• Mettre en place un pipeline CD vers dev/staging/production
• Implémenter blue-green deployment et canary releases pour zero-downtime
• Utiliser feature flags pour déploiement progressif et A/B testing
• Gérer les secrets de manière sécurisée (Vault, secrets managers)
• Intégrer SAST/SCA et gérer les environnements dynamiques par branche`, sortOrder: 16 },
      { title: "Analyse des Besoins & Faisabilité Technique", volumeHoraire: 28, periode: "Octobre / novembre", avecMentor: false, contenu: `• Cartographier les acteurs projet et définir leurs rôles (RACI/RASCI)
• Conduire des entretiens d'explicitation structurés
• Analyser l'environnement technique existant (SWOT)
• Identifier et quantifier les risques avec méthodologie structurée
• Proposer des stratégies de mitigation adaptées
• Rédiger un rapport de faisabilité avec recommandation Go/No-Go`, sortOrder: 17 },
    ],
  },
  {
    slug: "mastere-1-expert-ia", label: "Mastère 1 - Expert IA",
    level: "mastere", year: 1, specialization: "expert_ia", sortOrder: 11,
    title: "Mastère 1 - Expert en Intelligence Artificielle",
    introduction: "Ce programme avancé couvre les fondements théoriques et pratiques de l'IA moderne, du machine learning au deep learning, en passant par le NLP et la visualisation data.",
    subjects: [
      { title: "Traitement du langage naturel", volumeHoraire: 21, periode: "Février / mars", avecMentor: false, contenu: `• Comprendre et implémenter les pipelines NLP : tokenization, embeddings, attention mechanism
...
• Exploiter les embeddings (Sentence-Transformers) pour la recherche sémantique et le clustering`, sortOrder: 1 },
      { title: "Programmation python pour l'IA", volumeHoraire: 21, periode: "Octobre / novembre", avecMentor: false, contenu: `• Appliquer les principes SOLID et les pratiques Clean Code (Black, Ruff, MyPy) aux projets ML
...
• Implémenter des tests unitaires et d'intégration (Pytest) pour garantir la fiabilité du code ML`, sortOrder: 2 },
      { title: "ML : Apprentissage supervisé, non supervisé et par renforcement", volumeHoraire: 54, periode: "Janvier / février", avecMentor: false, contenu: `• Construire des pipelines Scikit-learn complets : preprocessing, feature engineering, model selection, validation croisée, GridSearchCV
...
• Choisir le paradigme ML adapté à un problème donné et justifier ses choix en situation professionnelle`, sortOrder: 3 },
      { title: "Mathématiques pour le ML et le DL", volumeHoraire: 21, periode: "Novembre / décembre", avecMentor: false, contenu: `•  Calculer des gradients multivariés, des jacobiennes et des hessiennes pour formaliser mathématiquement la backpropagation au-delà de l'implémentation vue en "Fondamentaux du Deep Learning"
...
•  Maîtriser la théorie de l'information appliquée au ML : entropy, cross-entropy, divergence KL, comprendre mathématiquement pourquoi on utilise telle loss function plutôt qu'une autre`, sortOrder: 4 },
      { title: "Fondamentaux du deep learning", volumeHoraire: 28, periode: "Février / mars", avecMentor: false, contenu: `• Dériver analytiquement la rétropropagation sur un réseau à 2 couches et l'implémenter from scratch en NumPy (dérivation en chaîne → gradients de chaque paramètre)
...
• Diagnostiquer un entraînement instable via TensorBoard : interpréter les courbes loss/accuracy, détecter overfitting/underfitting, ajuster le learning rate scheduling`, sortOrder: 5 },
      { title: "Visualisation et communication data", volumeHoraire: 21, periode: "Mars / avril", avecMentor: false, contenu: `• Appliquer les principes du design de visualisation (clarté, minimalisme, Tufte)
...
• Créer des démos interactives sur HuggingFace Spaces`, sortOrder: 6 },
      { title: "Veille technologique et éthique de la Data", volumeHoraire: 14, periode: "Mai / juillet", avecMentor: false, contenu: `• Mettre en place une stratégie de veille technologique (blogs tech, newsletters, conférences)
...
• Mesurer l'impact carbone des infrastructures data (GreenCloud, CodeCarbon)`, sortOrder: 7 },
      { title: "Statistiques, inférence et causalité", volumeHoraire: 21, periode: "Mars / avril", avecMentor: false, contenu: `• Analyser les besoins métier et définir les métriques de succès alignées sur les objectifs business
...
• Modéliser des distributions complexes et détecter les outliers`, sortOrder: 8 },
      { title: "Pilotage budgétaire et coordination d'équipe", volumeHoraire: 14, periode: "Avril / juin", avecMentor: false, contenu: `• Chiffrer les budgets cloud et infrastructure data (AWS vs GCP vs Azure vs stack Spark/Lakehouse)
...
• Produire des reportings et KPIs projet pour le management`, sortOrder: 9 },
      { title: "Modélisation et stockage des données", volumeHoraire: 14, periode: "Novembre", avecMentor: false, contenu: `• Modéliser un schéma dimensionnel pour BI et ML (Star Schema, Snowflake Schema)
• Choisir entre approches relationnelle, NoSQL et lakehouse selon les use cases
• Optimiser les index, partitions et compression pour accélérer les requêtes analytiques`, sortOrder: 10 },
      { title: "Méthodologies agiles pour projets data", volumeHoraire: 21, periode: "Avril / mai", avecMentor: false, contenu: `• Organiser un projet data en sprints avec user stories adaptées à l'ingénierie de données
...
• Communiquer l'avancement aux stakeholders avec des métriques adaptées`, sortOrder: 11 },
      { title: "Ingénierie des données et pipelines SQL", volumeHoraire: 21, periode: "Décembre / janvier", avecMentor: false, contenu: `• Écrire des requêtes SQL avancées : window functions, CTEs, optimisation avec EXPLAIN, jointures complexes
...
• Automatiser le versioning et la documentation des datasets (Dataset Cards) sur le Hub`, sortOrder: 12 },
      { title: "Documentation et accompagnement utilisateurs", volumeHoraire: 14, periode: "Mars / avril", avecMentor: false, contenu: `• Documenter l'API et l'intégration technique
• Créer des guides utilisateur avec workflows
• Expliquer les limitations et les risques du système
• Rédiger la documentation technique et former les utilisateurs aux outils développés`, sortOrder: 13 },
      { title: "Collecte et ingestion de données", volumeHoraire: 28, periode: "Janvier / février", avecMentor: false, contenu: `• Concevoir une architecture d'ingestion scalable avec Apache Kafka et Airflow
...
• Gérer les transformations précoces (early transformation) pour optimiser la qualité en amont`, sortOrder: 14 },
      { title: "Assurance qualité et résolution d'incidents", volumeHoraire: 14, periode: "Février / mars", avecMentor: false, contenu: `• Élaborer des scénarios de tests pour pipelines data (volumétrie, fraîcheur, cohérence, unicité)
...
• Mettre en place des alertes et seuils de qualité`, sortOrder: 15 },
      { title: "Analyse de besoins et cadrage métier", volumeHoraire: 21, periode: "Octobre", avecMentor: false, contenu: `• Conduire des ateliers de cadrage avec métiers et executives
...
• Rédiger un cahier des charges avec use cases prioritisés`, sortOrder: 16 },
    ],
  },
  {
    slug: "mastere-2-expert-ia", label: "Mastère 2 - Expert IA",
    level: "mastere", year: 2, specialization: "expert_ia", sortOrder: 12,
    title: "Mastère 2 - Expert en Intelligence Artificielle",
    introduction: "La deuxième année explore les frontières de l'IA : deep learning avancé, NLP, LLMs, MLOps et industrialisation de l'IA dans le cloud.",
    subjects: [
      { title: "Deep Learning", volumeHoraire: 63, periode: "Semestre 2", avecMentor: false, contenu: `- Comprendre et appliquer les bases mathématiques nécessaires au deep learning (algèbre linéaire, probabilités, statistiques) dans des contextes de data science. (C2.1.2, C5.1.2)
...
- Analyser les besoins clients et définir les axes d’analyse pour proposer des solutions adaptées. (C2.1.1, C2.1.2)`, sortOrder: 1 },
      { title: "Indus de l'IA dans le cloud", volumeHoraire: 63, periode: "Semestre 1", avecMentor: false, contenu: `- Mettre en œuvre les méthodes de MLOps pour automatiser le cycle de vie des projets d'IA, en utilisant des bibliothèques telles que MLflow pour assurer le tracking et la gestion des modèles. 
...
- Rédiger une documentation détaillée et accessible pour garantir une transmission claire des procédures d'implémentation et de maintenance des solutions IA dans le cloud.`, sortOrder: 2 },
      { title: "Data visualisation M2", volumeHoraire: 28, periode: "Semestre 1", avecMentor: false, contenu: `- Analyser les besoins métier pour cadrer les objectifs de visualisation des données. (C2.1.1)
...
- Sélectionner les composants techniques pour concevoir une infrastructure de visualisation robuste et dimensionnée aux besoins du projet. (C4.1.2)`, sortOrder: 3 },
      { title: "MLOps", volumeHoraire: 28, periode: "Semestre 2", avecMentor: false, contenu: `- Concevoir des pipelines de données temps réel ou asynchrones pour automatiser la transformation et la transmission des données. (C4.2.2, C1.1.3)
...
- Automatiser les tâches du cycle de vie des modèles avec des pipelines et des outils adaptés pour garantir leur mise à jour et leur efficacité. (C5.3.4)`, sortOrder: 4 },
      { title: "Natural Language processing", volumeHoraire: 63, periode: "Semestre 2", avecMentor: false, contenu: `Ce cours explore les concepts fondamentaux et avancés du traitement automatique du langage naturel (NLP). Les étudiants apprendront l’histoire et l’évolution des approches NLP, des premières méthodes de vectorisation (TF-IDF, One-Hot Encoding) aux techniques modernes comme les embeddings (Word2Vec, GloVe). Le programme inclut des architectures avancées telles que les RNN, LSTM bidirectionnels, et Seq2Seq, tout en introduisant les principes des modèles transformateurs (BERT, GPT) et des LLM (Large Language Models). Des outils comme SpaCy et HuggingFace seront utilisés pour les tâches de prétraitement, d’entraînement, et de déploiement de modèles. Une introduction au concept de Retrieval-Augmented Generation (RAG) permettra aux étudiants de relier NLP et gestion d’information pour des applications pratiques. Le cours inclut des exercices sur Python et des environnements comme TensorFlow et PyTorch.`, sortOrder: 5 },
      { title: "Large Language Model", volumeHoraire: 28, periode: "Semestre 2", avecMentor: false, contenu: `Ce cours approfondit les principes et applications des Large Language Models (LLM) tels que GPT et BERT, en mettant l’accent sur leur fonctionnement, leur entraînement, et leur optimisation. Les étudiants apprendront les concepts de pré-entraînement et de fine-tuning, les méthodes d’encodage textuel, ainsi que l’intégration des LLM dans des projets NLP concrets. À travers des cas pratiques, ils découvriront comment adapter ces modèles à des problématiques spécifiques, tout en explorant leur impact dans des domaines variés. L'approche pédagogique intègre la construction, le déploiement, et la supervision des modèles, permettant aux participants de développer des compétences techniques et stratégiques solides.`, sortOrder: 6 },
    ],
  },
  {
    slug: "mastere-1-data-engineer", label: "Mastère 1 - Data Engineering",
    level: "mastere", year: 1, specialization: "data_engineer", sortOrder: 13,
    title: "Mastère 1 - Expert Data Engineering",
    introduction: "Ce programme forme des Data Engineers capables de concevoir, construire et maintenir des architectures de données robustes et scalables pour des besoins analytiques et opérationnels.",
    subjects: [
      { title: "Visualisation et communication data", volumeHoraire: 21, periode: "Mars / avril", avecMentor: false, contenu: `• Appliquer les principes du design de visualisation (clarté, minimalisme, Tufte)
• Créer des dashboards interactifs avec Plotly, Dash et Gradio
• Raconter des histoires avec les données (data storytelling)
• Préparer des présentations impactantes pour executives (executive summaries)
• Créer des démos interactives sur HuggingFace Spaces`, sortOrder: 1 },
      { title: "Veille technologique et éthique de la Data", volumeHoraire: 14, periode: "Mai / juillet", avecMentor: false, contenu: `• Mettre en place une stratégie de veille technologique (blogs tech, newsletters, conférences)
• Évaluer les nouveaux outils et frameworks pour l'entreprise (ROI, maturité, communauté)
• Identifier et atténuer les biais dans les données et les pipelines
• Comprendre le cadre RGPD et ses implications pour l'ingénierie des données
• Mesurer l'impact carbone des infrastructures data (GreenCloud, CodeCarbon)`, sortOrder: 2 },
      { title: "Statistiques, inférence et causalité", volumeHoraire: 21, periode: "Mars / avril", avecMentor: false, contenu: `• Analyser les besoins métier et définir les métriques de succès alignées sur les objectifs business
• Réaliser des analyses d'inférence statistique : tests d'hypothèses (Student, Chi2, ANOVA), intervalles de confiance
• Implémenter des graphes causaux (DAGs) avec DoWhy ou CausalML pour l'analyse de scénarios
• Calculer la taille d'échantillon nécessaire et interpréter correctement les p-values et erreurs de type I/II
• Modéliser des distributions complexes et détecter les outliers`, sortOrder: 3 },
      { title: "Spark et traitement distribué", volumeHoraire: 33, periode: "Février / mars", avecMentor: false, contenu: `• Développer des applications PySpark performantes : RDDs, DataFrames, Spark SQL, UDFs optimisées
...
• Intégrer Spark dans des pipelines Airflow/Dagster avec SparkSubmitOperator`, sortOrder: 4 },
      { title: "Pipelines de données et Orchestration", volumeHoraire: 35, periode: "Janvier / février", avecMentor: false, contenu: `• Concevoir et implémenter des DAGs complexes avec par exemple Apache Airflow : scheduling, retry logic, SLAs, dépendances entre tâches
...
• Gérer les données en retard (late data), les backfills et les re-runs historiques sans duplication`, sortOrder: 5 },
      { title: "Pilotage budgétaire et coordination d'équipe", volumeHoraire: 14, periode: "Avril / juin", avecMentor: false, contenu: `• Chiffrer les budgets cloud et infrastructure data (AWS vs GCP vs Azure vs stack Spark/Lakehouse)
• Allouer les ressources entre projets concurrents
• Coordonner une équipe pluridisciplinaire (Data Engineers, Data Analysts, Métiers)
• Produire des reportings et KPIs projet pour le management`, sortOrder: 6 },
      { title: "Modélisation et stockage des données", volumeHoraire: 14, periode: "Novembre", avecMentor: false, contenu: `• Modéliser un schéma dimensionnel pour BI et ML (Star Schema, Snowflake Schema)
• Choisir entre approches relationnelle, NoSQL et lakehouse selon les use cases
• Optimiser les index, partitions et compression pour accélérer les requêtes analytiques`, sortOrder: 7 },
      { title: "Méthodologies agiles pour projets data", volumeHoraire: 21, periode: "Avril / mai", avecMentor: false, contenu: `• Organiser un projet data en sprints avec user stories adaptées à l'ingénierie de données
• Estimer la complexité des tâches data (exploration, modélisation, validation, déploiement)
• Gérer les risques techniques : données manquantes, pipelines instables, dérive de périmètre
• Planifier les livrables data avec milestones réalistes
• Communiquer l'avancement aux stakeholders avec des métriques adaptées`, sortOrder: 8 },
      { title: "Ingénierie des données et pipelines SQL", volumeHoraire: 21, periode: "Décembre / janvier", avecMentor: false, contenu: `• Écrire des requêtes SQL avancées : window functions, CTEs, optimisation avec EXPLAIN, jointures complexes
• Configurer des pipelines d'ingestion asynchrones (AIOHTTP, asyncio) pour la collecte à grande échelle
• Sélectionner et appliquer les technologies de transformation adaptées au volume (Pandas, HF Datasets, Spark)
• Développer des processus ETL robustes avec gestion d'erreurs, logging et tests de validation
• Utiliser HuggingFace Datasets pour charger, transformer et streamer des datasets volumineux (>10GB)
• Automatiser le versioning et la documentation des datasets (Dataset Cards) sur le Hub`, sortOrder: 9 },
      { title: "Documentation et accompagnement utilisateurs", volumeHoraire: 14, periode: "Mars / avril", avecMentor: false, contenu: `• Documenter l'API et l'intégration technique
• Créer des guides utilisateur avec workflows
• Expliquer les limitations et les risques du système
• Rédiger la documentation technique et former les utilisateurs aux outils développés`, sortOrder: 10 },
      { title: "DevOps et CI/CD pour la Data", volumeHoraire: 28, periode: "Février / mars", avecMentor: false, contenu: `• Mettre en place un pipeline CI/CD complet pour les projets data avec GitHub Actions : lint, test, build, deploy, rollback
...
• Implémenter des stratégies de déploiement blue-green et canary pour les pipelines en production`, sortOrder: 11 },
      { title: "Data Warehouse et Modélisation Analytique", volumeHoraire: 28, periode: "Novembre / décembre", avecMentor: false, contenu: `• Concevoir et implémenter un data warehouse avec schémas dimensionnels (Star Schema, Snowflake Schema) selon les principes de Kimball
...
• Connecter le data warehouse aux outils de visualisation (Metabase, Tableau, Power BI)`, sortOrder: 12 },
      { title: "Collecte et ingestion de données", volumeHoraire: 28, periode: "Janvier / février", avecMentor: false, contenu: `• Concevoir une architecture d'ingestion scalable avec Apache Kafka et Airflow
• Implémenter des connecteurs personnalisés pour APIs REST, bases relationnelles et cloud storage
• Orchestrer des workflows complexes avec gestion des dépendances et retry automatique
• Monitorer la santé des pipelines avec alerting et logging centralisé
• Gérer les transformations précoces (early transformation) pour optimiser la qualité en amont`, sortOrder: 13 },
      { title: "Assurance qualité et résolution d'incidents", volumeHoraire: 14, periode: "Février / mars", avecMentor: false, contenu: `• Élaborer des scénarios de tests pour pipelines data (volumétrie, fraîcheur, cohérence, unicité)
• Diagnostiquer et résoudre les incidents techniques en production
• Documenter les procédures de résolution (runbooks, post-mortems)
• Mettre en place des alertes et seuils de qualité`, sortOrder: 14 },
      { title: "Architecture de l'infrastructure Data", volumeHoraire: 21, periode: "Octobre / novembre", avecMentor: false, contenu: `• Analyser et comparer les architectures de traitement de données (Lambda, Kappa, Lakehouse, Data Mesh) selon les critères de coût, performance et scalabilité
...
• Produire un document d'architecture technique (ADR) justifiant les choix technologiques`, sortOrder: 15 },
      { title: "Analyse de besoins et cadrage métier", volumeHoraire: 21, periode: "Octobre", avecMentor: false, contenu: `• Conduire des ateliers de cadrage avec métiers et executives
• Identifier les données disponibles et les lacunes
• Définir des objectifs SMART et des KPIs mesurables
• Évaluer la faisabilité technique et les risques
• Rédiger un cahier des charges avec use cases prioritisés`, sortOrder: 16 },
  ...
  {
    slug: "mastere-1-systemes-embarques", label: "Mastère 1 - Systèmes Embarqués",
    level: "mastere", year: 1, specialization: "systemes_embarques", sortOrder: 14,
    title: "Mastère 1 - Expert Systèmes Embarqués et Objets Connectés",
    introduction: "Ce programme forme des experts en programmation embarquée, systèmes temps réel et architecture firmware, pour des applications dans l'industrie et l'IoT.",
    subjects: [
      { title: "Ingénierie des exigences & analyse des risques", volumeHoraire: 28, periode: "Année", avecMentor: false, contenu: `• Cartographier les parties prenantes et leurs attentes
...
• Produire un dossier de spécifications conforme à un standard d'ingénierie des exigences`, sortOrder: 1 },
      { title: "Veille technologique & positionnement", volumeHoraire: 14, periode: "Année", avecMentor: false, contenu: `• Mettre en place un système de veille technologique structuré et pérenne
...
• Présenter les opportunités d'innovation devant des décideurs`, sortOrder: 2 },
      { title: "Modélisation système", volumeHoraire: 21, periode: "Année", avecMentor: false, contenu: `• Réaliser un Block Definition Diagram et un Internal Block Diagram
...
• Tracer les exigences vers les éléments du modèle`, sortOrder: 3 },
      { title: "Architecture SE & choix technologiques", volumeHoraire: 21, periode: "Année", avecMentor: false, contenu: `• Comparer les langages embarqués selon contraintes matérielles et normes
...
• Produire un dossier de choix techniques argumenté`, sortOrder: 4 },
      { title: "Méthodologie, planification & suivi de projet SE", volumeHoraire: 28, periode: "Année", avecMentor: false, contenu: `• Choisir une méthodologie de gestion de projet adaptée au contexte SE
...
• Piloter la production de la documentation projet multi-contributeurs`, sortOrder: 5 },
      { title: "Animation d'équipe & leadership projet", volumeHoraire: 14, periode: "Année", avecMentor: false, contenu: `• Constituer une équipe projet équilibrée (compétences, complémentarité)
...
• Maintenir l'engagement des membres sur la durée du projet`, sortOrder: 6 },
      { title: "Fondamentaux : C embarqué, maths & physique", volumeHoraire: 35, periode: "Année", avecMentor: false, contenu: `• Manipuler pointeurs et allocation dynamique sans fuites mémoire
...
• Valider les acquis par des ateliers de remédiation hands-on`, sortOrder: 7 },
      { title: "Développement STM32 avancé", volumeHoraire: 28, periode: "Année", avecMentor: false, contenu: `• Configurer les canaux DMA pour transferts périphérique-mémoire à haut débit
...
• Produire un firmware professionnel documenté et livrable`, sortOrder: 8 },
      { title: "Achitecture firmware multi-tâches", volumeHoraire: 21, periode: "Année", avecMentor: false, contenu: `• Concevoir une architecture firmware multi-tâches professionnelle
...
• Documenter et maintenir l'architecture firmware sur la durée`, sortOrder: 9 },
      { title: "Conception matérielle", volumeHoraire: 42, periode: "Année", avecMentor: false, contenu: `• Écrire un module HDL synthétisable (compteur, FSM, acquisition PWM)
...
• Réaliser une revue de conception PCB en équipe`, sortOrder: 10 },
      { title: "Linux embarqué", volumeHoraire: 35, periode: "Année", avecMentor: false, contenu: `• Construire une image Linux embarqué minimale avec un outil type Buildroot
...
• Lire et comprendre un BSP fournisseur existant`, sortOrder: 11 },
      { title: "Qualité code, tests & gestion d'anomalies", volumeHoraire: 28, periode: "Année", avecMentor: false, contenu: `• Appliquer les règles d'un standard de codage embarqué sûr type MISRA-C
...
• Gérer un cycle complet de correction d'anomalie avec traçabilité`, sortOrder: 12 },
      { title: "CI/CD & gestion des versions", volumeHoraire: 14, periode: "Année", avecMentor: false, contenu: `• Configurer un pipeline CI cross-compilation ARM avec un orchestrateur CI/CD
...
• Mettre en place un environnement HIL basique pour tests automatisés`, sortOrder: 13 },
    ],
  },
  {
    slug: "mastere-2-systemes-embarques", label: "Mastère 2 - Systèmes Embarqués",
    level: "mastere", year: 2, specialization: "systemes_embarques", sortOrder: 15,
    title: "Mastère 2 - Expert Systèmes Embarqués et Objets Connectés",
    introduction: "La deuxième année s'oriente vers les systèmes critiques, l'IA embarquée, la physique mécanique et la certification de systèmes embarqués industriels.",
    subjects: [
      { title: "Science de l'ingénieur", volumeHoraire: 63, periode: "Semestre 1", avecMentor: false, contenu: `- Analyser les exigences fonctionnelles et non fonctionnelles d’un projet d’ingénierie pour établir un cahier des charges structuré. (B1.A1.C1, B1.A1.C4)
...
- Assurer la gestion des versions et la traçabilité des modifications techniques dans un projet d’ingénierie. (B4.A4.C2, B4.A4.C3)`, sortOrder: 1 },
      { title: "IA Embarquée", volumeHoraire: 63, periode: "Semestre 1", avecMentor: false, contenu: `Analyser les exigences fonctionnelles et non fonctionnelles des systèmes embarqués intégrant de l’IA. (B1.A1.C1, B1.A2.C1)
...
- Assurer la maintenance, la mise à jour et la traçabilité des systèmes embarqués intégrant de l’IA. (B4.A4.C1, B4.A4.C3)`, sortOrder: 2 },
      { title: "C Avancé", volumeHoraire: 63, periode: "Semestre 2", avecMentor: false, contenu: `Analyser les exigences fonctionnelles et non fonctionnelles d’un projet de développement en C avancé. (B1.A1.C1, B1.A2.C1)
...
Assurer la maintenance, l’optimisation et la gestion des versions du code. (B4.A4.C1, B4.A4.C3)`, sortOrder: 3 },
      { title: "Physique mécanique", volumeHoraire: 28, periode: "Semestre 1", avecMentor: false, contenu: `Ce cours vise à fournir aux étudiants une compréhension approfondie des principes de la mécanique appliqués aux systèmes embarqués. Ils apprendront à modéliser et simuler des phénomènes physiques en utilisant des outils numériques tels que MATLAB et Simulink pour rechercher des solutions optimisées (B1.A2.C1).
...
Enfin, ils établiront des stratégies de test et de validation en définissant des plans détaillés, en s’assurant du respect des normes et en développant des mises à jour pour améliorer continuellement les performances des systèmes embarqués (B4.A1.C1, B4.A3.C1, B4.A4.C3).`, sortOrder: 4 },
      { title: "Prise de parole en public n*2", volumeHoraire: 28, periode: "Semestre 2", avecMentor: false, contenu: `- Gérer son stress et son émotion face à l’auditoire en utilisant des techniques de relaxation et de concentration. (B2.A3.C2, B2.A3.C1)
...
- Analyser et améliorer ses prestations à travers des retours constructifs et des rétrospectives sur ses propres interventions. (B2.A3.C3, B2.A1.C2)`, sortOrder: 5 },
      { title: "Analyse numérique", volumeHoraire: 28, periode: "Semestre 1", avecMentor: false, contenu: `- Vérifier l'efficacité, la fiabilité et la conformité d'une architecture en réalisant des modélisations et des prototypes afin de valider la conception avant son implémentation détaillée (B3.A1.C2). 
...
- Maitriser les processus de recettage en conditions réelles, en définissant et exécutant un protocole de validation garantissant la conformité aux exigences fonctionnelles et non fonctionnelles du client (B4.A3.C2).`, sortOrder: 6 },
    ],
  },
];
